 ...
 */
namespace Magebulls\ConfigurablePreselect\Ui\DataProvider\Product\Form\Modifier;
                        ...
                        'arguments' => [
                            'data' => [
                                'config' => [
                                    ...
                                    'component' => 'Magebulls_ConfigurablePreselect/js/form/element/radio-set',
                                    'elementTmpl' => 'Magebulls_ConfigurablePreselect/form/components/radio-set',
