...
namespace Magebulls\ConfigurablePreselect\Block\Product\Renderer;
...
class Configurable extends \Magento\Swatches\Block\Product\Renderer\Configurable
{
     ...
     */
    const SWATCH_RENDERER_TEMPLATE = 'Magebulls_ConfigurablePreselect::product/view/renderer.phtml';
    ...
    public function getPreselectOptionId()
    {
        ...
        if(array_key_exists($this->getProduct()->getIsDefaultSimpleSelected(),$associated_option)){
            $result_data =  $associated_option[$this->getProduct()->getIsDefaultSimpleSelected()];
        }else{
